              ...
              <div key={c.id} className="relative group flex items-center bg-[#111] border border-[#1a1a1a] rounded-xl hover:border-[#252525] transition-colors">
                <a href={`/clientes/${c.id}`} className="flex items-center gap-3 flex-1 min-w-0 px-4 py-4">
                  <div className="min-w-0">
                    ...
                    <p className="text-[10px] text-[#444] uppercase tracking-wider mt-0.5 truncate">
                  ...
                  {dropdownAberto === c.id && (
                    <div
                      ...
                      <button
                        ...
                        className="flex items-center gap-2.5 w-full px-3 py-2.5 text-xs font-semibold text-[#666] hover:text-red-400 hover:bg-[#1e1e1e] rounded-lg transition-colors uppercase tracking-wider">
                        <svg width="13" height="13" fill="none" stroke="currentColor" strokeWidth="2.2" viewBox="0 0 24 24">
