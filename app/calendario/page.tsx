...
export default function CalendarioPage() {
  ...
  const s = {
    ...
    title: { fontSize: '32px', fontWeight: 800, color: '#fff', textTransform: 'uppercase' as const, letterSpacing: '-0.01em', marginBottom: '24px' },
    ...
    btnGhost: { background: '#1a1a1a', color: '#555', border: '1px solid #2a2a2a', borderRadius: '10px', padding: '10px 16px', fontSize: '11px', fontWeight: 700, textTransform: 'uppercase' as const, letterSpacing: '0.1em', cursor: 'pointer' } as React.CSSProperties,
  }
                ...
                {agendamentosDiaSelected.map(a => (
                  <div key={a.id} style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
                    <div style={{ display: 'flex', gap: '10px' }}>
                      ...
                      <div>
                        <p style={{ fontSize: '12px', fontWeight: 700, color: '#fff', textTransform: 'uppercase', letterSpacing: '0.05em' }}>{a.clientes?.nome || 'Sem Cliente'}</p>
